...
if(isset($_POST['operation_name'])){
	$found = check_customer_by_name_password($_POST['email'], $_POST['password']);
	if($found){
		$_SESSION['login_token'] = get_login_token($_POST['email'], $_POST['password']);
		header("Location: checkout.php");
    	exit();
	}else{
...
<body>
	...
	<script src="./js/pages/checkout_login_page.js"></script>
</body>
</html>